...
This [module](https://docs.viam.com/registry/modular-resources/) implements the a `rand:renogy:renogy` model as a a `rdk:component:power_sensor` [`` API]<INSERT LINK TO DOCS (if applicable)> in an <INSERT MODEL> model.
